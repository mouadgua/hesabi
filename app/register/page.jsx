...
import { registerUser, signUpWithGoogle } from './actions'
...
export default async function RegisterPage({ searchParams }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 font-sans">
      ...
      <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 my-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-500">
            Rejoignez la nouvelle ère de la pré-comptabilité.
          </p>
        </div>

...
/**
 * Verifies the current session is the admin.
 * Throws a plain Error('UNAUTHORIZED') — catch it in API routes to return 401,
 * or let it surface as a Server Action failure.
 */

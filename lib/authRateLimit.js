...
export const LIMITS = {
  ...
  // Demande d'accès bêta déposée depuis le site public. Plus permissif que le
  // contact : un cabinet entier derrière une même IP peut vouloir candidater
  // à plusieurs, et une demande refusée à tort est un prospect perdu. Assez
  // serré pour qu'un script n'y trouve pas d'intérêt.
  beta_request:  { max: 10, windowSec: 60 * 60 },
}
